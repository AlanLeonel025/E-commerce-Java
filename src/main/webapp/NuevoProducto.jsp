    ...
    <body>
        ...
        <div style="margin-top: 100px" class="row p-2">
            ...
            <div class="col mt-3 d-flex justify-content-end">
                <input id="txt-search" class="w-50 pl-2" type="text" placeholder="Buscar Producto...">
            </div>
        ...
        <table class="table">
            ...
            <thead class="mdb-color lighten-5">
                <tr>
                    ...
                    <th style="padding-left: 45px" class="font-weight-bold">Imagen</th>
        ...
        <div class="modal fade" id="modal-editor-producto" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                    ...
                    <div class="modal-body">
                        ...
                        <form>
                            ...
                            <div class="form-group">
                                ...
                                <input id="precio" name="precio" type="text" required="required" class="form-control">
                            </div>

                            <div class="form-group">
                                <label for="imagen">Imagen</label> 
                                <input id="imagen" name="imagen" type="file" required="required" class="form-control">
                            </div>
        ...
        <script src="js/jsonprod.js"></script>
        <!-- JQuery -->
